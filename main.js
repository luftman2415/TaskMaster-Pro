...
class TaskMaster {
    ...
    getDefaultAccentColor() {
        ...
        document.documentElement.setAttribute('data-theme-temp', theme);
        const color = getComputedStyle(document.documentElement).getPropertyValue(`--accent-color-default`).trim();
        document.documentElement.removeAttribute('data-theme-temp');
        return color || '#4facfe';
    }
