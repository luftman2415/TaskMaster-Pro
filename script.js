...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if ('serviceWorker' in navigator) {
        // AÑADIMOS UN PARÁMETRO "cache-busting" PARA FORZAR LA ACTUALIZACIÓN
        navigator.serviceWorker.register('./service-worker.js?v=4').then(reg => console.log('Service Worker v4: Registered')).catch(err => console.error('Service Worker v4: Registration failed', err));
    }
});